...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel_84-100_EF5.5264e-5
#SBATCH -o 1hel_84-100_EF5.5264e-5-%j.out
#SBATCH -e 1hel_84-100_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_isolated 1hel_parse_ph6 mesh/1hel_parse_ph6_d16_split 84 100 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_isolated 1hel_isolated/1hel_parse_ph6 1hel_isolated/mesh/1hel_parse_ph6_d16_split 84 100 5 2 1hel-isolated_84-100-2_pH6_EF5.5264e-5
