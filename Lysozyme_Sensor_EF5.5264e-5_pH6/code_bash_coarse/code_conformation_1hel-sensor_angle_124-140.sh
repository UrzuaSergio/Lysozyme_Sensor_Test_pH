...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_124-140_EF5.5264e-5
#SBATCH -o 1hel-sensor_124-140_EF5.5264e-5-%j.out
#SBATCH -e 1hel-sensor_124-140_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
cd ../../Lysozyme_Sensor_Test_pH/Lysozyme_Sensor_EF5.5264e-5_pH6/
###############################################################################################################################################################
...
python generador_config_file.py 1hel_sensor 1hel_parse_ph6 mesh/1hel_parse_ph6_d16_split 124 140 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel_parse_ph6 1hel_sensor/mesh/1hel_parse_ph6_d16_split 124 140 5 2 1hel-sensor_124-140-2_pH6_EF5.5264e-5
