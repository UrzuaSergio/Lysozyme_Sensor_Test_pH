...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_44-60_pH9_EF5.5264e-5
#SBATCH -o 1hel-sensor_44-60_pH9_EF5.5264e-5-%j.out
#SBATCH -e 1hel-sensor_44-60_pH9_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_sensor 1hel_parse_ph9 mesh/1hel_parse_ph9_d16_split 44 60 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel_parse_ph9 1hel_sensor/mesh/1hel_parse_ph9_d16_split 44 60 5 2 1hel-sensor_44-60-2_pH9_EF5.5264e-5
