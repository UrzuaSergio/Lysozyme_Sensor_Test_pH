...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel_64-80_pH9_EF5.5264e-5
#SBATCH -o 1hel_64-80_pH9_EF5.5264e-5-%j.out
#SBATCH -e 1hel_64-80_pH9_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_isolated 1hel_parse_ph9 mesh/1hel_parse_ph9_d16_split 64 80 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_isolated 1hel_isolated/1hel_parse_ph9 1hel_isolated/mesh/1hel_parse_ph9_d16_split 64 80 5 2 1hel-isolated_64-80-2_pH9_EF5.5264e-5
