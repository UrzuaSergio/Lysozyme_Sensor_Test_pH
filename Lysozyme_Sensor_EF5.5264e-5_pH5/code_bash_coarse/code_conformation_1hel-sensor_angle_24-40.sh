...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_24-40_pH5_EF5.5264e-5
#SBATCH -o 1hel-sensor_24-40_pH5_EF5.5264e-5-%j.out
#SBATCH -e 1hel-sensor_24-40_pH5_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_sensor 1hel_parse_ph5 mesh/1hel_parse_ph5_d16_split 24 40 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel_parse_ph5 1hel_sensor/mesh/1hel_parse_ph5_d16_split 24 40 5 2 1hel-sensor_24-40-2_EF5.5264e-5
