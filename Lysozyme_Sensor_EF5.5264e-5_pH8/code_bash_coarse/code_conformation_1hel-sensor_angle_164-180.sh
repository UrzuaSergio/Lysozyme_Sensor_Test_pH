...
#SBATCH -p gpuk
#SBATCH --gres=gpu:1
#SBATCH -J 1hel-sensor_164-180_pH8_EF5.5264e-5
#SBATCH -o 1hel-sensor_164-180_pH8_EF5.5264e-5-%j.out
#SBATCH -e 1hel-sensor_164-180_pH8_EF5.5264e-5-%j.err
#SBATCH --mem=2G
...
python generador_config_file.py 1hel_sensor 1hel_parse_ph8 mesh/1hel_parse_ph8_d16_split 164 180 2

echo "Se ha Creado Config File Auxiliar"
echo "Comenzo Ejecucion de PyGBe para Caso Proteina-Superficie Interactuando"
echo "%%%%%%%% Simulando %%%%%%%%"

python conformation_1hel.py 1hel_sensor 1hel_sensor/1hel_parse_ph8 1hel_sensor/mesh/1hel_parse_ph8_d16_split 164 180 5 2 1hel-sensor_164-180-2_pH8_EF5.5264e-5
